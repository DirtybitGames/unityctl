...
public static class SceneCommands
{
    public static Command CreateCommand()
    {
        ...
        listCommand.SetHandler(async (InvocationContext context) =>
        {
            ...
            var response = await client.SendCommandAsync(UnityCtlCommands.SceneList, args, timeout);
        ...
        loadCommand.SetHandler(async (InvocationContext context) =>
        {
            ...
            var response = await client.SendCommandAsync(UnityCtlCommands.SceneLoad, args, timeout);
            if (response == null) { context.ExitCode = 1; return; }
